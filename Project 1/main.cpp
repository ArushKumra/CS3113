...
constexpr glm::vec3 INIT_SCALE      = glm::vec3(2.5f, 5.263f, 0.0f),
                    INIT_POS_PRAY   = glm::vec3(2.0f, 0.0f, 0.0f),
                    INIT_POS_FREY = glm::vec3(-2.0f, 0.0f, 0.0f);
...
glm::vec3 g_rotation_pray = glm::vec3(0.0f, 0.0f, 0.0f),
          g_rotation_frey = glm::vec3(0.0f, 0.0f, 0.0f);
...
void update()
{
    ...
    g_pray_matrix = glm::rotate(g_pray_matrix, g_rotation_pray.y, glm::vec3(0.0f, 1.0f, 0.0f));
    g_pray_matrix = glm::scale(g_pray_matrix, INIT_SCALE);


    
    g_frey_matrix = glm::translate(g_frey_matrix, INIT_POS_FREY + glm::vec3(ticks*TRAN_INCREMENT,  0, 0));
    g_frey_matrix = glm::scale(g_frey_matrix, glm::vec3(0.5f, 0.5f, 0.5f));
}
